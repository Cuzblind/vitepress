...
2. 进入模型广场，左侧红框处就是创建API令牌步骤提到的令牌分组，右侧就是该分组下所存在的模型
...
![模型广场](/images/tutorial/image-20260324192752426.png)

![分组详情](/images/tutorial/image-20260324192904936.png)
...
- **分组介绍：**
  - vip客户使用的特定的模型，目前还在开发中，后续更新请留意公告。
